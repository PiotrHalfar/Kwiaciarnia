...
class PriceListControl {
	...
	public function action_priceListShow(){
		...
		if($this->validate())
		{
                    ...
                    if ( isset($this->form->itemname) && strlen($this->form->itemname) > 0) {
                            $search_params['itemname[~]'] = $this->form->itemname.'%'; // dodanie symbolu % zastępuje dowolny ciąg znaków na końcu
                    }
                    ...
                    $where ["ORDER"] = "itemname";
                    //wykonanie zapytania

                    try{
                            $this->records = App::getDB()->select("cennik", [
                                            "itemid",
                                            "itemname",
                                            "price",
		...
		App::getSmarty()->display('priceListView.tpl');
	}
